...
Future<void> main() {
  final config = FlutterTestConfiguration()
    ...
    //..hooks = [HookExample()]
    ..stepDefinitions = [GivenUserIsInXmenu(), AndPressXButton(), WhenPressXButton(),ThenAMessagesIsShown(), UserHasData(), FillXField(), SelectXOption(), SeeX(), GivenCurrentIs(), ThenCurrentIs(), XisSetOn(), TapX()]
